...
<div style="display: flex; justify-content: space-between; gap: 40px; flex-wrap: wrap;">
  ...
  <!-- Experience Card -->
  <div style="flex: 1; min-width: 300px; padding: 20px; border: 1px solid #ccc; border-radius: 10px;">
    ...
    <p style="text-align: center;">
      <a href="/professionalexperience.mde" style="font-weight: bold;">View Experience →</a>
    </p>
  </div>
  ...
  <div style="flex: 1; min-width: 300px; padding: 20px; border: 1px solid #ccc; border-radius: 10px;">
    ...
    <p style="text-align: center;">
      <a href="/hobbies.md" style="font-weight: bold;">View Hobbies →</a>
    </p>
  </div>
