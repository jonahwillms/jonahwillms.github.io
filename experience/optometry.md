...
layout: page
---
Research assistant for Hovis Lab at the University of Waterloo. Assisting in a study examining and developing methods to test for colour vision defects intended for pilots in the Royal Canadian Airfouce (RCAF). 
